...
def choose_target_color():
    ...
    if color_code:
        ...
        target_color_rgb.set(f"{int(color_code[0])},{int(color_code[1])},{int(color_code[2])}")
...
def choose_replacement_color():
    ...
    if color_code:
        ...
        replacement_color_rgb.set(f"{int(color_code[0])},{int(color_code[1])},{int(color_code[2])}")
...
def process_image():
    try:
        ...
        target = tuple(map(int, target_color_rgb.get().split(',')))
        replacement = tuple(map(int, replacement_color_rgb.get().split(',')))
...
target_color_rgb = tk.StringVar(value="255,255,255")
replacement_color_rgb = tk.StringVar(value="255,255,255")
